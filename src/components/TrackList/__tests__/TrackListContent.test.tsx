...
describe('TrackListContent', () => {
  const tracks: Track[] = [
    { id: 't1', title: 'Track 1', artist: '', album: '', genres: [], coverImage: '', audioFile: '', slug: '', createdAt: '', updatedAt: '' },
    { id: 't2', title: 'Track 2', artist: '', album: '', genres: [], coverImage: '', audioFile: '', slug: '', createdAt: '', updatedAt: '' },
    { id: 't3', title: 'Track 3', artist: '', album: '', genres: [], coverImage: '', audioFile: '', slug: '', createdAt: '', updatedAt: '' },
  ]
